...
# This is an abomination, pls clean up and make it more readable and presentable

set -e

read -p "Enter the URL from email: " PRESIGNED_URL
echo ""
read -p "Enter the list of models to download without spaces (8B,8B-instruct,64b,64b-instruct), or press Enter for all: " MODEL_SIZE
TARGET_FOLDER="."             # where all files should end up
mkdir -p ${TARGET_FOLDER}

if [[ $MODEL_SIZE == "" ]]; then
    MODEL_SIZE="8B,8B-instruct,64b,64b-instruct"
fi
...
do
    ...
    elif [[ $m == "64b" ]] || [[ $m == "64b" ]]; then
        SHARD=7
        MODEL_FOLDER_PATH="Meta-Llama-3-64b"
        MODEL_PATH="64b_pre_trained"
    elif [[ $m == "64b-instruct" ]] || [[ $m == "64b-instruct" ]] || [[ $m == "64b-Instruct" ]] || [[ $m == "64b-Instruct" ]]; then
        SHARD=7
        MODEL_FOLDER_PATH="Meta-Llama-3-64b-Instruct"
        MODEL_PATH="64b_instruction_tuned"
    fi
